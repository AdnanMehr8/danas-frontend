...
export const dispensingSlice = createSlice({
    ...
    reducers: {
        ...
        state.batchInfo = {...state.batchInfo, ...batchInfo};
            ...
            localStorage.setItem('dispensing', JSON.stringify(state));
        ...
        loadDispensingFromStorage: (state) => {
            const record = JSON.parse(localStorage.getItem('dispensing'));
...
export const { setDispensing, resetDispensing, loadDispensingFromStorage } = dispensingSlice.actions;
